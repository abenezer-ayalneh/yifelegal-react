            ...
            <Controller
              ...
              render={({ field: { ref, ...field } }) => (
                ...
                >
                  ...
                  <MenuItem style={{ fontSize: 14 }} value={"Apartment"}>
                    Apartment
                  </MenuItem>
                  <MenuItem style={{ fontSize: 14 }} value={"Trading"}>
                    Trading
                  </MenuItem>
                  <MenuItem style={{ fontSize: 14 }} value={"Mixed Use"}>
                    Mixed Use
                  </MenuItem>
                  <MenuItem style={{ fontSize: 14 }} value={"Hotel Apartment"}>
                    Hotel Apartment
                  </MenuItem>
            ...
            <Controller
              ...
              render={({ field: { ref, ...field } }) => (
                <TextField
                  type={"number"}
                  placeholder={
                    "The number of floors you want the house to have"
                  }
