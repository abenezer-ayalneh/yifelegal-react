...
const GroundPlusForSalePage = () => {
  ...
  const onNextHandler: SubmitHandler<GroundPlusForSaleType> = (values) => {
          ...
          <FormRow required={true} label={"Sub-City"} xs={12}>
            <Controller
              ...
              render={({ field: { ref, ...field } }) => (
                <TextField
                  placeholder={
                    "The sub-city of the groundPlus. E.g: Bole, Yeka"
                  }
                  label={"Sub-City"}
                  inputRef={ref}
            ...
            <Controller
              ...
              render={({ field: { ref, ...field } }) => (
                <TextField
                  type={"number"}
                  placeholder={
                    "The number of bedrooms you want the groundPlus to have"
                  }
            ...
            <Controller
              ...
              render={({ field: { ref, ...field } }) => (
                <TextField
                  type={"number"}
                  placeholder={
                    "The number of floors above ground floor. E.g: 2"
                  }
                  label={"Floor Number"}
                  size={"small"}
