...
const CondominiumForSalePage = () => {
  ...
  const onNextHandler: SubmitHandler<CondominiumForSaleType> = (values) => {
          ...
          <FormRow required={true} label={"Sub-City"} xs={12}>
            <Controller
              ...
              render={({ field: { ref, ...field } }) => (
                <TextField
                  placeholder={
                    "The sub-city of the condominium. E.g: Bole, Yeka"
                  }
                  label={"Sub-City"}
                  inputRef={ref}
          ...
          <FormRow label={"Special Condominium Name (if any)"} xs={12}>
            <Controller
              ...
              render={({ field: { ref, ...field } }) => (
                <TextField
                  placeholder={
                    "Special or local name of the condominium. E.g: Ayat, Tulu Dimtu..."
                  }
            ...
            <Controller
              ...
              render={({ field: { ref, ...field } }) => (
                <TextField
                  type={"number"}
                  placeholder={
                    "The number of bedrooms you want the condominium to have"
                  }
            ...
            <Controller
              ...
              render={({ field: { ref, ...field } }) => (
                <TextField
                  type={"number"}
                  placeholder={
                    "On which floor number do you want the condominium to be . E.g: 3"
                  }
                  label={"Floor Number"}
                  size={"small"}
