...
const CommercialBuildingForRentSchema = z.object({
    ...
    purpose: z.enum(["Hotel", "Cafe", "Cafe and Restaurant", "Supermarket", "Hypermarket", "Shop", "Office", "Gym", "Club", "Religious Institute", "School", "Storage Room", "Other"],
...
type CommercialBuildingForRentType = z.infer<typeof CommercialBuildingForRentSchema>
...
const CommercialBuildingForRent = () =>{
    ...
    const onSubmitHandler: SubmitHandler<CommercialBuildingForRentType> = (values) => {
        storeRequest({
            data: values
        },true).then((result) => {
            if(result.status){
    ...
    const onNextHandler: SubmitHandler<CommercialBuildingForRentType>  = (values) => {
                        ...
                        <Controller
                            ...
                            render={({field: {ref, ...field}}) => (
                                ...
                                >
                                    ...
                                    <MenuItem style={{fontSize: 14}} value={"Cafe"}>Cafe</MenuItem>
                                    <MenuItem style={{fontSize: 14}} value={"Cafe and Restaurant"}>Cafe and Restaurant</MenuItem>
                                    <MenuItem style={{fontSize: 14}} value={"Supermarket"}>Supermarket</MenuItem>
                                    <MenuItem style={{fontSize: 14}} value={"Hypermarket"}>Hypermarket</MenuItem>
                                    <MenuItem style={{fontSize: 14}} value={"Shop"}>Shop</MenuItem>
                                    <MenuItem style={{fontSize: 14}} value={"Office"}>Office</MenuItem>
                                    <MenuItem style={{fontSize: 14}} value={"Gym"}>Gym</MenuItem>
                                    <MenuItem style={{fontSize: 14}} value={"Club"}>Club</MenuItem>
                                    <MenuItem style={{fontSize: 14}} value={"Religious Institute"}>Religious Institute</MenuItem>
                                    <MenuItem style={{fontSize: 14}} value={"School"}>School</MenuItem>
                                    <MenuItem style={{fontSize: 14}} value={"Storage Room"}>Storage Room</MenuItem>
                                    <MenuItem style={{fontSize: 14}} value={"Other"}>Other</MenuItem>
                                </TextField>
                            )}
                        />
                    </FormRow>
