...
const GuestHouseVillaForRentPage = () => {
    ...
    const {
        ...
        handleSubmit,
        control,
    } = useForm<GuestHouseVillaForRentType>({
        resolver: zodResolver(GuestHouseVillaForRentSchema),
    ...
    const onSubmitHandler: SubmitHandler<GuestHouseVillaForRentType> = (values) => {
        storeRequest({
            data: values
        }, true).then((result) => {
            if (result.status) {
    ...
    const onNextHandler: SubmitHandler<GuestHouseVillaForRentType>  = (values) => {
...
export default GuestHouseVillaForRentPage