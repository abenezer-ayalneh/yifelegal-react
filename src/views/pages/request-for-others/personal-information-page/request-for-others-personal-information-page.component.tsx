...
const RequestForOthersPersonalInformationPage = () => {
    ...
    const onSubmitHandler: SubmitHandler<RequestForOthersPersonalInformationType> = (values) => {
        storeRequest({
            data: {
                ...values,
                ...location.state
    ...
    return (
        <Box>
            <Stack justifyContent={"center"} alignItems={"center"} direction={"column"}>
                <Typography variant={"h1"} style={{textTransform: "capitalize"}}>Client Information</Typography>
                <Typography variant={"subtitle2"} align={"center"}>Please fill the questions below about the requesting client</Typography>
            </Stack>
            <Box height={30}></Box>
