...
const ThreeWheelerMyRequestsPage = () => {
    ...
    const [selectedThreeWheelerDetail, setSelectedThreeWheelerDetail] = useState<RequestDetailType[] | null>(null)
    ...
    const handleHighlightClicked = (request: RequestDetailType[]) => setSelectedThreeWheelerDetail(request)
        ...
        return (
            <>
                ...
                </Grid>
                {
                    ...
                    <CustomModal open={Boolean(selectedThreeWheelerDetail)} title={"Request Detail"} handleClose={handleModalClose}>
