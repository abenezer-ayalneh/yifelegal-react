...
const MachineryAndTrucksMyRequestsPage = () => {
    ...
    const [selectedMachineryAndTrucksDetail, setSelectedMachineryAndTrucksDetail] = useState<RequestDetailType[] | null>(null)
    ...
    const handleHighlightClicked = (request: RequestDetailType[]) => setSelectedMachineryAndTrucksDetail(request)
        ...
        return (
            <>
                        ...
                        isRequestLoading
                            ...
                            : (myRequests.length === 0
                                    ...
                                    : myRequests.map((request: RequestType) => (
                                        <Highlight image={MachineryAndTrucks}
                ...
                </Grid>
                {
                    ...
                    <CustomModal open={Boolean(selectedMachineryAndTrucksDetail)} title={"Request Detail"} handleClose={handleModalClose}>
