...
const LandMyRequestsPage = () => {
    ...
    const [selectedLandDetail, setSelectedLandDetail] = useState<RequestDetailType[] | null>(null)
    ...
    const handleHighlightClicked = (request: RequestDetailType[]) => setSelectedLandDetail(request)
    ...
    if (!myRequests) {
        ...
        return (
            <>
                ...
                {
                    selectedLandDetail &&
                    <CustomModal open={Boolean(selectedLandDetail)} title={"Request Detail"} handleClose={handleModalClose}>
